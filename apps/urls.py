...
from apps.views import MainPageView, BlogListView, AboutPageView, ContactPageVIew, BlogPageView, RegisterPageView, \
    LoginPageView, CustomLogoutView, UserUpdateView, VerifyView, CreateCommentBLog, AddPost, SendMessageAdmin
...
urlpatterns = [
    ...
    path('contact/<str:username>', SendMessageAdmin.as_view(), name='send_message_admin'),
    ...
    path('add', AddPost.as_view(), name='add_blog'),
]
